  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="absolute bottom-[70px] right-[16px] sm:bottom-[75px] sm:right-[20px]"
      >
        <div
          className="
          ...
          "
        >
          {/*   hover:bg-accent/80 transition-transform duration-300 md:group-hover:translate-y-[-3px]  // Gentle hover float on desktop*/}
          <svg
